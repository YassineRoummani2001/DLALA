    ...
    <div class="row px-xl-5">
        <div class="col-12">
            <nav class="breadcrumb bg-light mb-30">
                ...
                <span class="breadcrumb-item active">Montrer</span>
            </nav>
        </div>
    </div>
</div>
    ...
    <div class="row px-xl-5">
            ...
            <div id="product-carousel" class="carousel slide" data-ride="carousel">
                <div class="carousel-inner bg-light pl-5 p-3 ">
                    ...
                    <div class="carousel-item">
                        <img width="300" height="300"  src="{{asset('assets/uploads/annonces/'.$annonce->photo2)}}" alt="{{asset('assets/img/img-v.jpg')}}">
                    </div>
                    <div class="carousel-item">
                        <img width="300" height="300"  src="{{asset('assets/uploads/annonces/'.$annonce->photo3)}}" alt="{{asset('assets/img/img-v.jpg')}}">
                    </div>
                    <div class="carousel-item">
        ...
        <div class="col-lg-7 h-auto mb-30">
            <div class="h-100 bg-light p-30">
                ...
                <h3 class="font-weight-semi-bold mb-4">{{$annonce->prix}} DH</h3>
            ...
            <div class="bg-light p-30">
                ...
                <div class="tab-content">
                    ...
                    <div class="tab-pane fade" id="tab-pane-3">
                        <div class="row">
                            <div class="col-md-6">
                                <h4 class="mb-4">1 review for {{$annonce->designation}}</h4>
                                <div class="media mb-4">
                                    <img src="{{asset('assets/img/account.png')}}" alt="Image" class="img-fluid mr-3 mt-1" style="width: 45px;">
                                    <div class="media-body">
                                        <h6>{{ Auth::user()->first_name }} {{ Auth::user()->name }}<small> - <i>{{ $annonce->created_at }}</i></small></h6>
